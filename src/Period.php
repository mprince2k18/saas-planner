...
use Carbon\Carbon;
use Mprince2k18\SaasPlanner\Exceptions\InvalidIntervalException;
...
class Period
{
     ...
     * @return  void
     *
     * @throws  \Mprince2k18\SaasPlanner\Exceptions\InvalidIntervalException
     */
    ...
    public static function getAllIntervals()
    {
        ...
        foreach (array_keys(self::$intervalMapping) as $interval) {
            $intervals[$interval] = trans('saas-planner::messages.'.$interval);
        }
