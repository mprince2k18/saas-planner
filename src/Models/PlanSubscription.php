...
use Mprince2k18\SaasPlanner\Events\SubscriptionCanceled;
use Mprince2k18\SaasPlanner\Events\SubscriptionCreated;
use Mprince2k18\SaasPlanner\Events\SubscriptionRenewed;
use Mprince2k18\SaasPlanner\Events\SubscriptionSaved;
use Mprince2k18\SaasPlanner\Events\SubscriptionSaving;
use Mprince2k18\SaasPlanner\Period;
use Mprince2k18\SaasPlanner\SubscriptionAbility;
use Mprince2k18\SaasPlanner\SubscriptionUsageManager;
use Mprince2k18\SaasPlanner\Traits\BelongsToPlan;
...
class PlanSubscription extends Model implements PlanSubscriptionInterface
{
     ...
     *
     * @var Mprince2k18\SaasPlanner\SubscriptionAbility
     */
    protected $ability;
    ...
    {
        return $this->hasMany(
            config('saas-planner.models.plan_subscription_usage'),
            'subscription_id'
        );
    }
     ...
     *
     * @return \Mprince2k18\SaasPlanner\SubscriptionAbility
     */
