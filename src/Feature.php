...
class Feature
{
     ...
     * @return void
     *
     * @throws  \Mprince2k18\SaasPlanner\Exceptions\InvalidPlanFeatureException
     */
    public function __construct($feature_code)
    {
        ...
        $feature = config('saas-planner.features.'.$feature_code);
    ...
    {
        $features = config('saas-planner.features');
